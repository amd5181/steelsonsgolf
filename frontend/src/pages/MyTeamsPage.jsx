        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    ...
                    {g ? (
                      <>
                        ...
                        {golferMap[g.name] ? (
                          ...
                          <span className="flex-1 text-sm font-bold text-red-600 truncate min-w-0">
                            {g.name}<span className="ml-1.5 text-xs font-normal text-red-500 whitespace-nowrap">· Not in field</span>
                          </span>
                        )}
                  ...
                  <button
                    ...
                    className={`flex-shrink-0 flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-bold transition-all ${
                      saving
                        ...
                        : hasPendingChanges
                        ? 'bg-yellow-400 text-yellow-900 animate-save-glow'
            ...
            <div className="bg-white rounded-xl border border-[#1B4332]/25 shadow-sm overflow-hidden">
              ...
              <div className="p-3 border-b border-slate-300 flex items-center gap-2">
